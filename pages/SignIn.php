...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($usernameErr) && empty($pwdErr) && empty($firstNameErr) && empty($lastNameErr)) {
        ...
        if (mysqli_connect_errno()) {
            ...
            //     . "AND 'password = '$pwd'";
            $query = "SELECT *  FROM user WHERE pwd = '$pwd' AND email = '$username'";
...
<body class="text-center">
    ...
    <main class="form-signin w-100 m-auto">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <h1 class="h3 mb-3 fw-normal">Log in Now!</h1>
            ...
            <div class="form-floating">
                <input type="password" class="form-control <?php if (!empty($pwdErr)) echo 'is-invalid'; ?>" id="floatingPassword" placeholder="Password" name="pwd" value="<?php echo $pwd; ?>">
